...
public class NorwegianOrganizationNumberRuleTest extends X509TestGenerator {
    ...
    @Test
    public void shouldExtractOrgnumberFromBuypassG2Cert() throws Exception {
        final String ORGNR = "123123123";
        X509Certificate cert = createX509Certificate("C = NO, O = test, OU = SEID 2 test, CN = test, organizationIdentifier = NTRNO-"+ORGNR);
